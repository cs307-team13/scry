...
public class TaskDataSource {
	...
	@Deprecated
	public String temp_friends[] = { "mhoward20158@gmail.com",
			"titanfan94@gmail.com" };
	...
	public long addFriend(String email) {
		...
		return frienddatabase.insert(TaskStoreContract.FriendEntry.TABLE_NAME,
				null, values);
	}

	public List<String> getFriends() {
		open();
		Cursor cursor = frienddatabase.query(
				TaskStoreContract.FriendEntry.TABLE_NAME,
				TaskStoreContract.FriendEntry.allColumns, null, null, null,
				null, null);
	...
	public long commitTaskWithoutPush(Task t) {
		...
		long id = taskdatabase.insert(TaskStoreContract.TaskEntry.TABLE_NAME,
				null, values);
		t.setId(id);
		return id;
	}
	...
	public List<Task> getAllTasks() {
		...
		Cursor cursor = taskdatabase.query(
				...
				TaskStoreContract.TaskEntry.allColumns, null, null, null, null,
				null);
	...
	public List<String> getCategories() {
		...
		// TaskStoreContract.TaskEntry.TABLE_NAME,
		// new String[] { TaskStoreContract.TaskEntry.COLUMN_NAME_ENTRY_CATEGORY
		// }, null,
		// null, null, null,
	...
	public Task cursorToTask(Cursor cursor) {
		...
		task.setKey(cursor.getString(cursor
				.getColumnIndexOrThrow(TaskStoreContract.TaskEntry.COLUMN_NAME_ENTRY_CREATOR_ID)));
	...
	private List<Task> query(String selection, String[] selectionArgs,
		...
		Cursor cursor = taskdatabase.query(true,
				TaskStoreContract.TaskEntry.TABLE_NAME,
				TaskStoreContract.TaskEntry.allColumns, selection,
