...
public final class TaskStoreContract {
    ...
    public static abstract class TaskEntry implements BaseColumns {
    	...
    	public static final String SQL_CREATE_ENTRIES =
    	    ...
    	    TaskStoreContract.TaskEntry.COLUMN_NAME_ENTRY_TITLE + TEXT_TYPE + COMMA_SEP + // Any other options for the CREATE command
    	    ...
    	    TaskStoreContract.TaskEntry.COLUMN_NAME_ENTRY_CATEGORY + TEXT_TYPE +
    	    " )";
