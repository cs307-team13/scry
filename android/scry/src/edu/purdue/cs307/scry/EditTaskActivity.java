...
TaskDatasourceActivity ,CreateNdefMessageCallback{
	...
	public NdefMessage createNdefMessage(NfcEvent arg0) {
		...
		NdefMessage msg = new NdefMessage(
				new NdefRecord[]{ NdefRecord.createMime("application/edu.purdue.cs307.scry.EditTaskActivity",text.getBytes()),NdefRecord.createApplicationRecord("edu.purdue.cs307.scry")
				});
