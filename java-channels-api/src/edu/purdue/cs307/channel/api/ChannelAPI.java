package edu.purdue.cs307.channel.api;
...
public class ChannelAPI {
    ...
    private String BASE_URL = "http://1-dot-scryserver.appspot.com/server"; //Defaults to http://localhost:8888
    //private final String CHANNEL_URL = "/server"; //"/_ah/channel/";
    ...
    private String createChannel(String key) throws IOException, ClientProtocolException{
		...
		try{
			...
			System.out.println("About to make json object");
			JSONObject json = new JSONObject(xhr.getResponseText().substring(xhr.getResponseText().indexOf("{")));
    ...
    public void close() throws IOException {
        ...
        disconnect(sendGet(BASE_URL)); //getUrl("disconnect")));
    }
