...
public class ChannelListener implements ChannelService {
	...
	public void onOpen() {
		...
		System.out
				.println("This is the \"Defualt Class\" You Should Realy Implement Your Own Version of \"ChannelService\" :-)");
	}
	...
	public void onError(Integer errorCode, String description) {
		...
		System.out.println("Error Occured: " + description + " Error Code:"
				+ errorCode);
		System.out
				.println("This is the \"Defualt Class\" You Should Realy Implement Your Own Version of \"ChannelService\" :-)");
	}
