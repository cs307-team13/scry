...
import edu.purdue.cs307.channel.api.ChannelAPI;
import edu.purdue.cs307.channel.api.ChannelAPI.ChannelException;
...
public class ChatExample {
	...
	public ChatExample(){
		try {
			channel = new ChannelAPI("http://1-dot-scryserver.appspot.com/server", "key", chatListener); //Production Example
